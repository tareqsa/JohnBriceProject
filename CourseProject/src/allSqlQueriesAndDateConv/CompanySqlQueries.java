...
public class CompanySqlQueries 
{
	...
	public static String companies_by_name = "SELECT * FROM company WHERE COMP_NAME='%1s'";
	...
	public static String companies_by_compName_and_password = "SELECT * FROM company WHERE COMP_NAME ='%1s' and PASSWORD ='%2s'";
