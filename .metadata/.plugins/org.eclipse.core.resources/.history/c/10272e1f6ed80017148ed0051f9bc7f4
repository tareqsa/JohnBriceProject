...
public interface CouponDAO 
{
	 ...
	 * @throws DuplicateEntryException the duplicate entry exception 
	 */
	public void updateCoupon(Coupon coup) throws ClassNotFoundException, InterruptedException, SQLException, ParseException, NullConnectionException, EmptyEntryException, DuplicateEntryException;
